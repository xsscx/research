...
|------|-----|-------------|
| **iccanalyzer-lite** | 20,400+ | 141-heuristic security analyzer with ASAN/UBSAN, TIFF image analysis, JSON output, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 141-heuristic security scan
