...
|------|-----|-------------|
| **iccanalyzer-lite** | 17,500+ | 138-heuristic security analyzer with ASAN/UBSAN, TIFF image analysis, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 138-heuristic security scan
