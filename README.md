...
|------|-----|-------------|
| **iccanalyzer-lite** | 15,500+ | 127-heuristic security analyzer with ASAN/UBSAN, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 127-heuristic security scan
