...
|------|-----|-------------|
| **iccanalyzer-lite** | 22,400+ | 159-heuristic security analyzer with ASAN/UBSAN, TIFF image analysis, JSON/XML/Report output, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 159-heuristic security scan
