...
|------|-----|-------------|
| **iccanalyzer-lite** | 22,400+ | 170-heuristic security analyzer with ASAN/UBSAN, TIFF image analysis, JSON/XML/Report output, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 170-heuristic security scan
