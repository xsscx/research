...
|------|-----|-------------|
| **iccanalyzer-lite** | 22,400+ | 161-heuristic security analyzer with ASAN/UBSAN, TIFF image analysis, JSON/XML/Report output, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 161-heuristic security scan
