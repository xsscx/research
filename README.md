...
|------|-----|-------------|
| **iccanalyzer-lite** | 15,500+ | 132-heuristic security analyzer with ASAN/UBSAN, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 132-heuristic security scan
