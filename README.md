...
|------|-----|-------------|
| **iccanalyzer-lite** | 15,500+ | 115-heuristic security analyzer with ASAN/UBSAN, callgraph, OOM protection, Ninja mode |
...
- **analyze-icc-profile** — Full 115-heuristic security scan
