...
static const ConformanceCheck kConformanceRegistry[] = {
  ...
  {"CF-330", "Device Spectral Colour Space Signature",
   "Validates spectral colour space signature (rs/ts/es/bs/sm) in device colour space header field", "ICC.2:2023 §7.2.8 amend",
   CFSeverity::WARNING, CFCategory::V5},
  {"CF-331", "Device Spectral Range Source Requirement",
   "When device colour space is spectral, spectral range must be defined by dsrn tag or header fallback", "ICC.2:2023 §7.2.8 + §9.2.x",
   CFSeverity::ERROR, CFCategory::V5},
  {"CF-332", "spectralRangeType Reserved Bytes",
   "Validates spectralRangeType (srng) reserved bytes and minimum 20-byte size in dsrn tag", "ICC.2:2023 §10.2.w",
   CFSeverity::ERROR, CFCategory::V5},
  {"CF-333", "devicePccTag Sub-Tag Completeness",
   "Validates devicePccTag (dpcc) presence and defers sub-tag completeness to H177", "ICC.2:2023 §12.2.y",
   CFSeverity::WARNING, CFCategory::V5},
  {"CF-334", "PCC pcsIlluminantXYZMbr Required",
   "pcsIlluminantXYZMbr (iXYZ) is mandatory in every profileConnectionConditionsStructure", "ICC.2:2023 §12.2.y.2.1",
   CFSeverity::ERROR, CFCategory::V5},
  {"CF-335", "PCC mediaWhitePointMbr Conditional",
   "mediaWhitePointMbr (mwpt) conditionality in profileConnectionConditionsStructure", "ICC.2:2023 §12.2.y.2.2",
   CFSeverity::WARNING, CFCategory::V5},
  {"CF-336", "PCC spectralWhitePointMbr Conditional",
   "spectralWhitePointMbr (swpt) conditionality in profileConnectionConditionsStructure", "ICC.2:2023 §12.2.y.2.3",
   CFSeverity::WARNING, CFCategory::V5},
  {"CF-337", "Device Spectral Range vs Header Consistency",
   "Cross-validates dsrn tag spectral range against header spectralRange fields when both present", "ICC.2:2023 §7.2.8 + §7.2.22",
   CFSeverity::WARNING, CFCategory::V5},
  {"CF-338", "Bi-Spectral Device Range Zero Check",
   "Non-bi-spectral device types must have zero biSpectralRange in spectralRangeType", "ICC.2:2023 §10.2.w",
   CFSeverity::ERROR, CFCategory::V5},
