...
| H14 | TagArrayType (tary) | Cleanup() crash / UAF risk - CVE-2026-34535 |
...
| H29 | ColorantTable string validation | Unterminated name[32] -> strlen overflow | GHSA-4wqv-pvm8-5h27, GHSA-p9wm-xfv4-43qg, CVE-2026-34556 |
...
| H64 | Chromatic adaptation validation | 3x3 matrix determinant and conditioning |
...
| H110 | Class tag validation | Required tags per profile class (Sec.8) |
...
| ID | Check | Risk |
|----|-------|------|
| H139 | Strip geometry validation | StripByteCounts vs RowsPerStripxWidth bounds - CWE-122/CWE-190 |
