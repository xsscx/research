...
const HeuristicEntry kHeuristicRegistry[] = {
  ...
  {  1, "Profile Size",                        "Sec.7.2.2",  "CWE-131", nullptr, HeuristicPhase::HEADER, HeuristicSeverity::MEDIUM},
  {  2, "Magic Bytes",                         "Sec.7.2.6",  "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  3, "Color Space Signature",               "Sec.7.2.6",  "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  4, "PCS Color Space",                     "Sec.7.2.7",  "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  5, "Platform/CMM/Manufacturer/Creator",    "Sec.7.2.10", "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  6, "Rendering Intent",                    "Sec.7.2.15", "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  7, "Profile Class",                       "Sec.7.2.5",  "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  {  8, "Illuminant XYZ",                      "Sec.7.2.16", "CWE-682", nullptr, HeuristicPhase::HEADER, HeuristicSeverity::MEDIUM},
  { 15, "Date Validation",                     "Sec.7.2.4",  "CWE-20",  nullptr, HeuristicPhase::HEADER, HeuristicSeverity::LOW},
  { 16, "Signature Patterns",                  "Sec.7.2",    "CWE-506", nullptr, HeuristicPhase::HEADER, HeuristicSeverity::INFO},
  { 17, "Spectral Range",                      "Sec.7.2.22", "CWE-843", nullptr, HeuristicPhase::HEADER, HeuristicSeverity::MEDIUM},

  // --- TAG VALIDATION (H9-H14, H18-H32) ---
  {  9, "Critical Text Tags",                  "Sec.7.3",    "CWE-476", "CVE-2026-21496,CVE-2026-21497,GHSA-7gv7-cmrv-4j85,GHSA-wj8m-6w77-r4rw", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 10, "Tag Count",                           "Sec.7.3",    "CWE-20",  "CVE-2026-21680,GHSA-mgp7-w4w3-mhx4", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::MEDIUM},
  { 11, "CLUT Entry Limit",                    "Sec.10.10",  "CWE-190", "CVE-2026-21677,CVE-2026-22255,CVE-2026-30986,CVE-2026-31794,GHSA-6jrq-wfqg-wv7w,GHSA-92v9-wq22-2rfv,GHSA-95w5-jvqf-3994,GHSA-qv2w-mq3g-73gv,GHSA-w3g9-rmvh-49gh,GHSA-x6gg-j72w-jc9w", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 12, "MPE Chain Depth",                     "Sec.10.26",  "CWE-674", "CVE-2026-21500,CVE-2026-21501,GHSA-4h4j-mm9w-2cp4,GHSA-x7hw-h22p-2x4w", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 13, "Per Tag Size Check",                  "Sec.7.3.1",  "CWE-400", nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 14, "Tag Array Detection",                 "Sec.10.33",  "CWE-416", "CVE-2026-34535,GHSA-965q-9pp6-6vw5", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 18, "Technology Signature",                "Sec.9.2.27", "CWE-20",  nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::LOW},
  { 19, "Tag Offset Overlap",                  "Sec.7.3.1",  "CWE-122", "CVE-2021-30942,CVE-2022-26730", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 20, "Tag Type Signature",                  "Sec.10",     "CWE-843", "CVE-2026-21505,CVE-2026-24856,GHSA-j577-8285-qrf9,GHSA-w585-cv3v-c396", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 21, "Tag Struct Member Inspection",        "Sec.10.32",  "CWE-843", nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::MEDIUM},
  { 22, "Num Array Scalar Expectation",        "Sec.10.21",  "CWE-20",  nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::LOW},
  { 23, "Num Array Value Range",               "Sec.10.21",  "CWE-681", nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::MEDIUM},
  { 24, "Tag Struct Nesting Depth",            "Sec.10.32",  "CWE-674", "CVE-2026-30980,GHSA-w478-77q7-2hc2", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 25, "Tag Offset OOB",                      "Sec.7.3.1",  "CWE-125", "CVE-2026-21487,GHSA-xq7x-9524-f7cp", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 26, "Named Color2String Validation",       "Sec.10.20",  "CWE-170", nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 27, "MPE Matrix Output Channel",           "Sec.10.26",  "CWE-131", "CVE-2026-27692,GHSA-3869-prw8-gjqr", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 28, "LUT Dimension Validation",            "Sec.10.10",  "CWE-400", "CVE-2026-21490,CVE-2026-21494,GHSA-9q9c-699q-xr2q,GHSA-hjxv-xr7w-84fc,GHSA-x9hr-pxxc-h38p", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 29, "Colorant Table String Validation",    "Sec.10.4",   "CWE-125/CWE-170", "CVE-2026-34556,GHSA-4wqv-pvm8-5h27,GHSA-p9wm-xfv4-43qg", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 30, "Gamut Boundary Desc Allocation",      "Sec.10.12",  "CWE-400", "GHSA-rc3h-95ph-j363", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::HIGH},
  { 31, "MPE Channel Count",                   "Sec.10.26",  "CWE-131", nullptr, HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  { 32, "Tag Data Type Confusion",             "Sec.10",     "CWE-843", "CVE-2021-30942,CVE-2026-21683,CVE-2026-21688,CVE-2026-21691,CVE-2026-25503,GHSA-3r2x-j7v3-pg6f,GHSA-c9q5-x498-jv92,GHSA-f2wp-j3fr-938w,GHSA-pf84-4c7q-x764", HeuristicPhase::TAG_VALIDATION, HeuristicSeverity::CRITICAL},
  ...
  { 54, "Division-by-Zero Trigger Detection",     nullptr, "CWE-369", "CVE-2026-21495,CVE-2026-34546,GHSA-fxgq-wf5v-25pq,GHSA-xhrm-79rg-5784", HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
  ...
  { 96, "Embedded Profile Validation",           nullptr, "CWE-674", "CVE-2026-25503,CVE-2026-34550,GHSA-pf84-4c7q-x764,GHSA-rmxp-pxf4-p7wm", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::HIGH},
  { 97, "Profile Sequence Id Validation",        nullptr, "CWE-400", nullptr, HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::HIGH},
  { 98, "Spectral MPE Element Validation",       nullptr, "CWE-787", "CVE-2026-34534,GHSA-7x9w-g476-wcc2", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},
  ...
  {106, "Env Var",                               nullptr, "CWE-131", "CVE-2026-34537,GHSA-3m63-c4jf-592f", HeuristicPhase::PROFILE_COMPLIANCE, HeuristicSeverity::MEDIUM},
  ...
  {110, "Class Tag Validation",                  "Sec.8",    "CWE-20",  nullptr, HeuristicPhase::PROFILE_COMPLIANCE, HeuristicSeverity::LOW},
  {111, "Reserved Bytes",                        "Sec.7.2.19", "CWE-20", nullptr, HeuristicPhase::PROFILE_COMPLIANCE, HeuristicSeverity::LOW},
  ...
  {128, "Version BCD",                           "Sec.7.2.4", "CWE-20", "CVE-2026-24403,GHSA-ph33-qp8j-5q34", HeuristicPhase::INTEGRITY, HeuristicSeverity::LOW},
  {129, "PCS Illuminant D50",                    "Sec.7.2.16", "CWE-20", nullptr, HeuristicPhase::INTEGRITY, HeuristicSeverity::LOW},
  {130, "Tag Alignment",                         "Sec.7.3.1", "CWE-20", nullptr, HeuristicPhase::INTEGRITY, HeuristicSeverity::LOW},
  ...
  {133, "Flags Reserved Bits",                   "Sec.7.2.11", "CWE-20", nullptr, HeuristicPhase::INTEGRITY, HeuristicSeverity::LOW},
  {134, "Tag Type Reserved Bytes",               "Sec.10.1", "CWE-20",  nullptr, HeuristicPhase::INTEGRITY, HeuristicSeverity::LOW},
  {135, "Duplicate Tag Signatures",              "Sec.7.3.1", "CWE-694", nullptr, HeuristicPhase::INTEGRITY, HeuristicSeverity::HIGH},
  ...
  {139, "TIFF Strip Geometry Validation",        nullptr, "CWE-122", "CVE-2026-31797,CVE-2026-34539,GHSA-4f3j-q8mm-5hr6,GHSA-wh2p-cm3r-7hm3", HeuristicPhase::IMAGE, HeuristicSeverity::CRITICAL},
  ...
  {142, "XML Serialization Safety",              "Sec.10",   "CWE-787", "CVE-2026-21498,CVE-2026-21499,CVE-2026-21500,CVE-2026-21502,CVE-2026-21506,CVE-2026-21674,CVE-2026-21678,CVE-2026-21682,CVE-2026-21689,CVE-2026-21690,CVE-2026-21692,CVE-2026-21693,CVE-2026-22046,CVE-2026-24404,CVE-2026-24406,CVE-2026-24407,CVE-2026-24408,CVE-2026-24409,CVE-2026-24410,CVE-2026-24411,CVE-2026-24412,CVE-2026-24852,CVE-2026-25502,CVE-2026-30981,CVE-2026-30983,CVE-2026-31792,CVE-2026-31796,CVE-2026-34548,CVE-2026-34556,GHSA-2f26-vh48-38g6,GHSA-2pjj-3c98-qp37,GHSA-398q-4rpv-3v9r,GHSA-398v-jvcg-p8f3,GHSA-4h4j-mm9w-2cp4,GHSA-5rqc-w93q-589m,GHSA-67r8-q3mh-42j6,GHSA-6822-qvxq-m736,GHSA-6rf4-63j2-cfrf,GHSA-7662-mf46-wr88,GHSA-7v4q-mhr2-hj7r,GHSA-9rp2-4c6g-hppf,GHSA-c2qq-jf7w-rm27,GHSA-c3pv-2cpf-7v2p,GHSA-h3ph-mwq5-3883,GHSA-h9h3-45cm-j95f,GHSA-hqfg-45jp-hp9f,GHSA-j3mh-rjg5-8gw7,GHSA-jq9m-54gr-c56c,GHSA-m6gx-93cp-4855,GHSA-mv6h-vpcg-pwfx,GHSA-p9wm-xfv4-43qg,GHSA-pmcg-2h65-35h8,GHSA-prwp-9gv6-ccxv,GHSA-q8g2-mp32-3j7f,GHSA-v3q7-7hw6-6jq8,GHSA-wfm7-m548-x4vp,GHSA-x53f-7h27-9fc8,GHSA-xqq3-g894-w2h5,GHSA-xww6-v3vg-4qc7", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},
  {143, "XML Array Bounds Precheck",             "Sec.10",   "CWE-131", "CVE-2026-21673,CVE-2026-21682,CVE-2026-22046,CVE-2026-30981,GHSA-7v4q-mhr2-hj7r,GHSA-g66g-f82c-vgm6,GHSA-jq9m-54gr-c56c,GHSA-pmcg-2h65-35h8,GHSA-xqq3-g894-w2h5", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::HIGH},
  {144, "XML String Termination Precheck",       "Sec.10.4", "CWE-170", "CVE-2026-24852,CVE-2026-25502,CVE-2026-30983,CVE-2026-34556,GHSA-4wqv-pvm8-5h27,GHSA-c2qq-jf7w-rm27,GHSA-h3ph-mwq5-3883,GHSA-p9wm-xfv4-43qg,GHSA-q8g2-mp32-3j7f", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::HIGH},
  {145, "XML Curve Type Consistency",            "Sec.10.14","CWE-843", "CVE-2026-21493,CVE-2026-21689,CVE-2026-21690,CVE-2026-21692,CVE-2026-21693,CVE-2026-24411,CVE-2026-24412,CVE-2026-31796,GHSA-2f26-vh48-38g6,GHSA-2pjj-3c98-qp37,GHSA-5rqc-w93q-589m,GHSA-6rf4-63j2-cfrf,GHSA-7662-mf46-wr88,GHSA-mv6h-vpcg-pwfx,GHSA-p85g-f9q7-jmjx,GHSA-v3q7-7hw6-6jq8,GHSA-x53f-7h27-9fc8", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},

  // --- ADVANCED DATA VALIDATION (H146-H148) ---
  {146, "Stack Buffer Overflow GetValues",       "Sec.10.6", "CWE-121", "CVE-2026-24404,CVE-2026-24406,CVE-2026-34555,GHSA-983c-rgh5-4982,GHSA-f79r-m9wh-wr6j,GHSA-h9h3-45cm-j95f,GHSA-hqfg-45jp-hp9f,GHSA-rxfr-c2c7-v5m5", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},
  {147, "Null Pointer After Tag Read",           "Sec.7.3",  "CWE-476", "CVE-2021-30942,CVE-2022-26730,CVE-2026-24852,CVE-2026-25502,CVE-2026-31792,GHSA-4wqv-pvm8-5h27,GHSA-c2qq-jf7w-rm27,GHSA-j3mh-rjg5-8gw7,GHSA-q8g2-mp32-3j7f", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},
  {148, "Memory Copy Bounds Overlap",            "Sec.10.14","CWE-119", "CVE-2026-24407,CVE-2026-31793,GHSA-m6gx-93cp-4855,GHSA-vgr5-3xqx-vcqx", HeuristicPhase::DATA_VALIDATION, HeuristicSeverity::CRITICAL},
  ...
  {151, "Calculator Operator Enum Validation",    "Sec.10.26","CWE-681", "CVE-2026-34533,GHSA-8jj3-77m7-c3pq", HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {152, "Curve Element OOM Size Validation",       "Sec.10.26","CWE-770", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {153, "Sampled Curve NaN-to-Unsigned Cast",     "Sec.10.26","CWE-681", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},

  // --- CODEQL-DRIVEN HEURISTICS (H154-H161) ---
  {154, "Uncontrolled Tag Allocation Size",       "Sec.7.3",  "CWE-789", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {155, "Integer Overflow in Tag Dimensions",     "Sec.10.6", "CWE-190", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {156, "Allocation Failure Path Profiles",       "Sec.7.3",  "CWE-252", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
  {157, "Alloc-Dealloc Mismatch Tag Patterns",    "Sec.10.14","CWE-762", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {158, "Enum Range Violation Detection",         "Sec.10.26","CWE-681", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
  {159, "UAF Tag Ownership Chain Detection",      "Sec.7.3",  "CWE-416", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {160, "Format String Injection in Text Tags",   "Sec.10.24","CWE-134", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {161, "Stack Address Escape Deep Apply Chains", "Sec.10.14","CWE-121", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},

  // -- Exploit-Gap Heuristics (H162-H169) --
  {162, "Partial Tag Data Overlap Detection", "Sec.7.3","CWE-119", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {163, "Executable Signature Scan In Tag Data", "Sec.7.3","CWE-506", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
  {164, "Raw LUT Channel vs ColorSpace/PCS Cross-Check", "Sec.10.6","CWE-131", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {165, "LUT Data Sufficiency Validation", "Sec.10.6","CWE-125", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {166, "Division-by-Zero in CAM/Array/MPE", "Sec.10.26","CWE-369", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
  {167, "Null MPE CLUT/Curve Application Guard", "Sec.10.10","CWE-476", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {168, "Unchecked Allocation Size Overflow", "Sec.7.3","CWE-789", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::CRITICAL},
  {169, "Dictionary Tag Element Bounds", "Sec.10.22","CWE-789", nullptr, HeuristicPhase::RAW_POST, HeuristicSeverity::HIGH},
