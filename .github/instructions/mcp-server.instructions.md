...
| 3 | `analyze_security` | 153-heuristic security scan (H1–H153) |
...
| `GET` | `/api/security` | `path` | 153-heuristic scan (text) |
| `GET` | `/api/security-json` | `path` | 153-heuristic scan (JSON) |
...
- **Heuristic count mismatch** — The #2 recurring issue. When heuristic count changes
  (currently 153), update ALL locations: `icc_profile_mcp.py` docstrings,
