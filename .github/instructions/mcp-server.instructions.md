...
| 3 | `analyze_security` | 171-heuristic security scan (H1–H171) |
...
| `GET` | `/api/security` | `path` | 171-heuristic scan (text) |
| `GET` | `/api/security-json` | `path` | 171-heuristic scan (JSON) |
...
- **Heuristic count mismatch** — The #2 recurring issue. When heuristic count changes
  (currently 171), update ALL locations: `icc_profile_mcp.py` docstrings,
