...
| 3 | `analyze_security` | 159-heuristic security scan (H1–H159) |
...
| `GET` | `/api/security` | `path` | 159-heuristic scan (text) |
| `GET` | `/api/security-json` | `path` | 159-heuristic scan (JSON) |
...
- **Heuristic count mismatch** — The #2 recurring issue. When heuristic count changes
  (currently 159), update ALL locations: `icc_profile_mcp.py` docstrings,
