...
- `analyze-icc-profile.prompt.yml` — full 132-heuristic security scan
...
2. **`analyze_security`** — Run the 132-heuristic security scan (H1–H132)
...
- Look for `[H1]`–`[H132]` prefixes to identify which heuristic triggered
