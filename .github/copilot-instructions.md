...
- `analyze-icc-profile.prompt.yml` — full 115-heuristic security scan
...
2. **`analyze_security`** — Run the 115-heuristic security scan (H1–H115)
