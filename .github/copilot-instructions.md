...
- `analyze-icc-profile.prompt.yml` — full 127-heuristic security scan
...
2. **`analyze_security`** — Run the 127-heuristic security scan (H1–H127)
...
- Look for `[H1]`–`[H106]` prefixes to identify which heuristic triggered
