...
- `analyze-icc-profile.prompt.yml` — full 148-heuristic security scan
...
auto-detects TIFF format, extracts embedded ICC profiles, and runs full 148-heuristic analysis (H1-H138 on ICC + H139-H141 on TIFF + H142-H145 XML + H146-H148 data validation).
...
2. **`analyze_security`** — Run the 148-heuristic security scan (H1–H148)
...
- `analyze_security` — 148-heuristic security scan (fastest, most actionable)
...
|-----------|---------|--------------|
| **iccanalyzer-lite/** | 148-heuristic security analyzer (ASAN+UBSAN). Links **unpatched** upstream iccDEV — does NOT receive CFL patches. | [iccanalyzer-lite.instructions.md](instructions/iccanalyzer-lite.instructions.md) |
