...
**cfl/iccDEV**: separate clone inside `cfl/` — 19 patches applied (CFL-001–CFL-031, 13 retired upstream)
...
# Build CFL fuzzers (clones iccDEV, applies 19 patches, builds 12 fuzzers)
cd cfl && ./build.sh
...
| `cfl/iccDEV/` | CFL fuzzer build (19 patches applied (CFL-001–CFL-031, 13 retired upstream)) | Yes |
