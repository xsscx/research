...
TIFF_8BIT="$TP/catalyst-8bit-ACESCG.tiff"
TIFF_16BIT="$TP/catalyst-16bit-ITU2020.tiff"
TIFF_32BIT="$TP/catalyst-32bit-ITU709.tiff"
TIFF_MISMATCH="$TP/catalyst-16bit-mismatch.tiff"
TIFF_MUTATED="$TP/catalyst-16bit-mutated.tiff"
PNG_CVE="$TP/p0-2225-cve-2021-30942-colorsync-uninit-mem.png"
JPG_CVE="$TP/p0-2225-cve-2021-30942-colorsync-uninit-mem.jpg"
