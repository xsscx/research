---
mode: agent
description: Generate diverse CoreGraphics image seeds for iccDEV TIFF/JPEG/PNG fuzzer coverage
---

# macOS Agent: Generate Diverse Image Seeds
...
3 sizes per config: 4x4, 32x32, 256x256.
...
|-----|-------|-----|------|---------|
| A | wl_380.tif..wl_780.tif (81 files, step 5nm) | 16 | 4x4 | Gradient ramp per wavelength |
| B | ch8_01.tif..ch8_08.tif (8 files) | 8 | 32x32 | Distinct gray levels per channel |
| C | lg_001.tif..lg_010.tif (10 files) | 16 | 256x256 | Larger images with patterns |
| D | digit_0.tif..digit_9.tif (10 files) | 8 | 64x64 | Rendered digit patterns |
...
|---|--------|-------------|------|-------|
| 1 | JPEG | sRGB | 256x256 | Standard JPEG+ICC (APP2 segment) |
| 2 | JPEG | DisplayP3 | 512x512 | Wide gamut JPEG |
| 3 | JPEG | AdobeRGB | 128x128 | Print-targeted |
| 4 | PNG | sRGB (iCCP) | 64x64 | Standard PNG+ICC |
| 5 | PNG | DisplayP3 (iCCP) | 256x256 | Wide gamut PNG |
| 6 | PNG | Grayscale (iCCP) | 32x32 | Mono PNG+ICC |
