---
mode: agent
description: Work with iccDEV JSON config tooling (iccToJson, iccFromJson, iccApplyNamedCmm)
---

# iccDEV JSON Configuration Tooling
...
2. dstEncoding sweep
3. Rendering intent sweep (4 intents x 3 interpolation)
