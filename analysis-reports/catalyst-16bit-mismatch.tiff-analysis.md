...
--- Embedded ICC Profile ---
  ...
  Extracted ICC from TIFF to: /tmp/iccanalyzer-ZedKUw.icc
...
File: /tmp/iccanalyzer-ZedKUw.icc
...
Profile: /tmp/iccanalyzer-ZedKUw.icc
...
Exported 0 text file(s) to /tmp/tmp.tQAEnkREB0/
```
