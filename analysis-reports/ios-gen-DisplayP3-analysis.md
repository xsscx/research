...
**Profile**: `test-profiles/ios-gen-DisplayP3.icc`
**File Size**: 536 bytes
...
File: /home/h02332/po/research/test-profiles/ios-gen-DisplayP3.icc
...
=======================================================================
  ...
  [exiftool]
      ...
      File Name                       : ios-gen-DisplayP3.icc
  ...
  [identify]
      Image:
        Filename: /home/h02332/po/research/test-profiles/ios-gen-DisplayP3.icc
        Permissions: rw-r--r--
  ...
  [xxd -l 128]
      ...
      00000020: 0000 0000 6163 7370 4150 504c 0000 0000  .ICC_DEBUG: [iccDEV/IccProfLib/IccSignatureUtils.h:288] IsValidColorSpaceSignature(): input = 0x52474220 (RGB)
...acspAPPL....
  ...
  [sha256sum]
      0ff6958f98684c61f6bbdce1368ddeaf3873baf84545baba482e920d92a914c0  /home/h02332/po/research/test-profiles/ios-gen-DisplayP3.icc
...
Profile: /home/h02332/po/research/test-profiles/ios-gen-DisplayP3.icc
...
Header Fields (RAW - no validation):
  Profile Size:    0x00000218 (536 bytes) OK
  CMM:             0x6170706C  'appl'
  Version:         0x04000000
...
---  ------------ ------------ ------------ ------------ ------------ ------
0    0x64657363   'desc'        0x000000FC   0x00000030   'mluc'        OK
1    0x63707274   'cprt'        0x0000012C   0x00000050   'mluc'        OK
2    0x77747074   'wtpt'        0x0000017C   0x00000014   'XYZ '        OK
3    0x7258595A   'rXYZ'        0x00000190   0x00000014   'XYZ '        OK
4    0x6758595A   'gXYZ'        0x000001A4   0x00000014   'XYZ '        OK
5    0x6258595A   'bXYZ'        0x000001B8   0x00000014   'XYZ '        OK
6    0x72545243   'rTRC'        0x000001CC   0x00000020   'para'        OK
7    0x63686164   'chad'        0x000001EC   0x0000002C   'sf32'        OK
8    0x62545243   'bTRC'        0x000001CC   0x00000020   'para'        OK
9    0x67545243   'gTRC'        0x000001CC   0x00000020   'para'        OK

=== FULL FILE HEX DUMP (all 536 bytes) ===
0x0000: 00 00 02 18 61 70 70 6C  04 00 00 00 6D 6E 74 72  |....appl....mntr|
0x0010: 52 47 42 20 58 59 5A 20  07 E6 00 01 00 01 00 00  |RGB XYZ ........|
0x0020: 00 00 00 00 61 63 73 70  41 50 50 4C 00 00 00 00  |....acspAPPL....|
0x0030: 41 50 50 4C 00 00 00 00  00 00 00 00 00 00 00 00  |APPL............|
...
0x00D0: 00 00 01 CC 00 00 00 20  63 68 61 64 00 00 01 EC  |....... chad....|
0x00E0: 00 00 00 2C 62 54 52 43  00 00 01 CC 00 00 00 20  |...,bTRC....... |
0x00F0: 67 54 52 43 00 00 01 CC  00 00 00 20 6D 6C 75 63  |gTRC....... mluc|
0x0100: 00 00 00 00 00 00 00 01  00 00 00 0C 65 6E 55 53  |............enUS|
0x0110: 00 00 00 14 00 00 00 1C  00 44 00 69 00 73 00 70  |.........D.i.s.p|
0x0120: 00 6C 00 61 00 79 00 20  00 50 00 33 6D 6C 75 63  |.l.a.y. .P.3mluc|
0x0130: 00 00 00 00 00 00 00 01  00 00 00 0C 65 6E 55 53  |............enUS|
0x0140: 00 00 00 34 00 00 00 1C  00 43 00 6F 00 70 00 79  |...4.....C.o.p.y|
0x0150: 00 72 00 69 00 67 00 68  00 74 00 20 00 41 00 70  |.r.i.g.h.t. .A.p|
0x0160: 00 70 00 6C 00 65 00 20  00 49 00 6E 00 63 00 2E  |.p.l.e. .I.n.c..|
0x0170: 00 2C 00 20 00 32 00 30  00 32 00 32 58 59 5A 20  |.,. .2.0.2.2XYZ |
0x0180: 00 00 00 00 00 00 F6 D5  00 01 00 00 00 00 D3 2C  |...............,|
0x0190: 58 59 5A 20 00 00 00 00  00 00 83 DF 00 00 3D BF  |XYZ ..........=.|
0x01A0: FF FF FF BB 58 59 5A 20  00 00 00 00 00 00 4A BF  |....XYZ ......J.|
0x01B0: 00 00 B1 37 00 00 0A B9  58 59 5A 20 00 00 00 00  |...7....XYZ ....|
0x01C0: 00 00 28 38 00 00 11 0B  00 00 C8 B9 70 61 72 61  |..(8........para|
0x01D0: 00 00 00 00 00 03 00 00  00 02 66 66 00 00 F2 A7  |..........ff....|
0x01E0: 00 00 0D 59 00 00 13 D0  00 00 0A 5B 73 66 33 32  |...Y.......[sf32|
0x01F0: 00 00 00 00 00 01 0C 42  00 00 05 DE FF FF F3 26  |.......B.......&|
0x0200: 00 00 07 93 00 00 FD 90  FF FF FB A2 FF FF FD A3  |................|
0x0210: 00 00 03 DC 00 00 C0 6E                           |.......n|
