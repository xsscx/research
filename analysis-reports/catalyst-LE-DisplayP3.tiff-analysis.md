...
--- Embedded ICC Profile ---
  ...
  Extracted ICC from TIFF to: /tmp/iccanalyzer-10Rnzn.icc
...
File: /tmp/iccanalyzer-10Rnzn.icc
...
Profile: /tmp/iccanalyzer-10Rnzn.icc
...
Exported 0 text file(s) to /tmp/tmp.6fQKHHZlKP/
```
