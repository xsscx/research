...
File: /home/h02332/po/research/test-profiles/sRGB_v4_ICC_preference.icc
...
[CF-002] Date/Time Leap Year Validation (ICC.1-2022-05 §7.2.8)
         Month=7 — leap year check not applicable
...
[CF-010] Profile Size vs File Size (ICC.1-2022-05 §7.2.2)
         Header size: 60960 bytes, File size: 60960 bytes
...
[CF-011] Profile ID MD5 Verification (ICC.1-2022-05 §7.2.18)
         Profile ID: 34562abf994ccd066d2c5721d0d68c5d — MD5 verified
...
[CF-185] Profile ID Size Consistency (ICC.1-2022-05 §7.2.18, RFC 1321 §3.1)
         Header-declared size: 60960 bytes
         Actual file size: 60960 bytes
...
[H1215] CF-215: JPEG APP2 Embedding Size Limit
  [CF-215] JPEG APP2 Embedding Size Limit (ICC TN Embedding §JFIF)
         Profile size: 60960 bytes (JPEG limit: 16707345 bytes)
...
[H1219] CF-219: Container Format Version Matrix
  [CF-219] Container Format Version Matrix (ICC TN Embedding §Table 1)
         Profile version: 4.x, class: spac
         PNG: v4 widely supported in practice (spec says v2)
         Compatible with 15+ media formats (of 18 surveyed)
...
[H1188] CF-188: Global Per-Tag Validate() Sweep
  [CF-188] Global Per-Tag Validate() Sweep (SampleICC §3 Compliance)
         Swept 9 tags: 9 OK, 0 warnings, 0 errors
...
[CF-229] Rendering Intent Dominance Per Class (v2->v4 TN)
         AToB tags: 2, BToA tags: 2, class: 0x73706163
...
[CF-234] v4 Perceptual PCS Reference Medium (ICC.1-2022-05 Annex D)
         Lab PCS with perceptual intent: reference medium dynamic range 287.9:1
         Reference white: L*=100 (89% reflectance), black: L*=3.1373
         [OK] Profile has perceptual intent with Lab PCS -- reference medium applies
      [OK] Conformant
...
[CF-045] ColorSpace Profile Required Tags (ICC.1-2022-05 §8.7 Table 31)
         ...
         'B2A0' (BToA0Tag): present
         [OK] ColorSpace profile required tags present
      [OK] Conformant
...
[H1095] CF-095: Non-Required Tag Identification
  [CF-095] Non-Required Tag Identification (ICC.1-2022-05 §8)
           ...
           Additional tag: 'B2A0' (0x42324130)
           Additional tag: 'B2A1' (0x42324131)
           Additional tag: 'rig0' (0x72696730)
...
[H1117] CF-117: Rendering Intent Tags per Class
  [CF-117] Rendering Intent Tags per Class (ICC.1-2022-05 §8.3-8.5)
           perceptualRenderingIntentGamutTag in non-Output/Display profile
           [WARN] rig0 only valid for Output/Display — §9.2.36
...
[H1205] CF-205: Tag Data Region Gap Analysis
  [CF-205] Tag Data Region Gap Analysis (ICC.1-2022-05 §7.3)
           ...
           Data coverage: 60716 / 60960 bytes (99.6%)
...
[CF-068] Chromatic Adaptation Matrix Invertible (ICC.1-2022-05 §9.2.10)
         Determinant = 0.779839 — matrix is invertible
...
[CF-165] LUT Matrix Determinant Non-Singular (ICC v4 Matrix Entries TN)
         Tag 'AToB0' — determinant = 1.000000 (invertible)
         Tag 'AToB1' — determinant = 1.142892 (invertible)
         Tag 'BToA0' — determinant = 1.000000 (invertible)
         Tag 'BToA1' — determinant = 0.874977 (invertible)
...
[CF-179] Chad D50-to-D50 Identity Check (ICC TN Partial Adaptation)
         Illuminant is D50 but chad deviates from identity (max dev = 0.247864)
...
[CF-183] Chad Column Normalization (ICC TN Partial Adaptation)
         Column 0 norm = 1.0485
         Column 1 norm = 0.9907
         Column 2 norm = 0.7540
...
[H1099] CF-099: Round-Trip CIEDE2000
  [CF-099] Round-Trip Transform CIEDE2000 (ICC.1-2022-05 §8)
           [GAP] A2B0/B2A0 present but Only classic lut8/lut16 quality metrics are currently supported
      GAP: A2B0/B2A0 present but Only classic lut8/lut16 quality metrics are currently supported
      [OK] Conformant

[H1100] CF-100: Curve Invertibility
  [CF-100] Curve Invertibility Check (ICC.1-2022-05 §10.6)
           A2B0 A[0]: avg inv err=0.000000  max err=0.000000
           A2B0 A[1]: avg inv err=0.000000  max err=0.000000
           A2B0 A[2]: avg inv err=0.000000  max err=0.000000
           A2B0 M[0]: avg inv err=0.000000  max err=0.000000
           A2B0 M[1]: avg inv err=0.000000  max err=0.000000
           A2B0 M[2]: avg inv err=0.000000  max err=0.000000
           A2B0 B[0]: avg inv err=0.000000  max err=0.000000
           A2B0 B[1]: avg inv err=0.000000  max err=0.000000
           A2B0 B[2]: avg inv err=0.000000  max err=0.000000
           B2A0 A[0]: avg inv err=0.017145  max err=0.183594
           B2A0 A[1]: avg inv err=0.017145  max err=0.183594
           B2A0 A[2]: avg inv err=0.017145  max err=0.183594
           B2A0 M[0]: avg inv err=0.000000  max err=0.000000
           B2A0 M[1]: avg inv err=0.000000  max err=0.000000
           B2A0 M[2]: avg inv err=0.000000  max err=0.000000
           B2A0 B[0]: avg inv err=0.000000  max err=0.000000
           B2A0 B[1]: avg inv err=0.000000  max err=0.000000
           B2A0 B[2]: avg inv err=0.000000  max err=0.000000
           A2B1 A[0]: avg inv err=0.000000  max err=0.000000
           A2B1 A[1]: avg inv err=0.000000  max err=0.000000
           A2B1 A[2]: avg inv err=0.000000  max err=0.000000
           A2B1 M[0]: avg inv err=0.000000  max err=0.000000
           A2B1 M[1]: avg inv err=0.000000  max err=0.000000
           A2B1 M[2]: avg inv err=0.000000  max err=0.000000
           A2B1 B[0]: avg inv err=0.000000  max err=0.000000
           A2B1 B[1]: avg inv err=0.000000  max err=0.000000
           A2B1 B[2]: avg inv err=0.000000  max err=0.000000
           B2A1 A[0]: avg inv err=0.000000  max err=0.000000
           B2A1 A[1]: avg inv err=0.000000  max err=0.000000
           B2A1 A[2]: avg inv err=0.000000  max err=0.000000
           B2A1 M[0]: avg inv err=0.000000  max err=0.000000
           B2A1 M[1]: avg inv err=0.000000  max err=0.000000
           B2A1 M[2]: avg inv err=0.000000  max err=0.000000
           B2A1 B[0]: avg inv err=0.000000  max err=0.000000
           B2A1 B[1]: avg inv err=0.000000  max err=0.000000
           B2A1 B[2]: avg inv err=0.000000  max err=0.000000
           [OK] 36 curve(s) checked — invertibility metrics recorded
      [OK] Conformant
...
Profile: /home/h02332/po/research/test-profiles/sRGB_v4_ICC_preference.icc
...
```
=== Extracting LUT data as text from: /home/h02332/po/research/test-profiles/sRGB_v4_ICC_preference.icc ===
