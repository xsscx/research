...
async def analyze_security(path: str) -> str:
    """Run 161-heuristic security analysis on an ICC profile.
...
async def analyze_security_json(path: str) -> str:
    """Run 161-heuristic security analysis with structured JSON output.
...
async def analyze_security_report(path: str) -> str:
    """Run 161-heuristic security analysis with professional report output.
