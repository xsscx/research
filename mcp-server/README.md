...
|---|---|---|
| `analyze-icc-profile` | Full 148-heuristic security scan | `{{profile_path}}` |
...
All 148 heuristics should show `[OK]`. **WebUI:** <http://127.0.0.1:8080/#security>
...
| 3 | `analyze_security` | Analysis | 148-heuristic security scan (H1–H148) |
...
| `GET` | `/api/security` | `path` | 148-heuristic security scan |
