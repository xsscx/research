...
|---|---|---|
| `analyze-icc-profile` | Full 153-heuristic security scan | `{{profile_path}}` |
...
| 3 | `analyze_security` | Analysis | 153-heuristic security scan (H1–H153) |
...
| `GET` | `/api/security` | `path` | 153-heuristic security scan |
