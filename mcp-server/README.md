...
|---|---|---|
| `analyze-icc-profile` | Full 150-heuristic security scan | `{{profile_path}}` |
...
| 3 | `analyze_security` | Analysis | 150-heuristic security scan (H1–H150) |
...
| `GET` | `/api/security` | `path` | 150-heuristic security scan |
