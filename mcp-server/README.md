...
|---|---|---|
| `analyze-icc-profile` | Full 159-heuristic security scan | `{{profile_path}}` |
...
| 3 | `analyze_security` | Analysis | 159-heuristic security scan (H1–H159) |
...
| `GET` | `/api/security` | `path` | 159-heuristic security scan |
