...
|---|---|---|
| `analyze-icc-profile` | Full 161-heuristic security scan | `{{profile_path}}` |
...
| 3 | `analyze_security` | Analysis | 161-heuristic security scan (H1–H161) |
...
| `GET` | `/api/security` | `path` | 161-heuristic security scan |
